...
- **Статус:** `Accepted implementation baseline — G-04/G-05/G-06/G-07A PASS; WP-11 candidate`
- **Дата:** 2026-08-23
...
- `G-07A AI/VLM Harness Foundation` — `PASS 2026-08-23`: native-first,
  ...
  остаются `BLOCKED`;
- `WP-11 Common Domain Process Kernel` — implementation candidate 2026-08-23:
  local PostgreSQL 17, Candidate→Fact authority, common process chain,
  four-mode reuse and reset isolation pass; canonical PostgreSQL 18 CI pending;
...
WP-11 принят локально как implementation candidate и ожидает canonical CI.
Следующий work package после его принятия определяется
