...
18. **WP-12 Tender Slice v0.1** — local acceptance candidate 2026-08-23:
    ...
    disposable PostgreSQL 17; canonical PostgreSQL 18 CI pending. It does not
...
является local acceptance candidate до canonical CI и не начинает WP-13.
