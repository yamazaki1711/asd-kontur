...
19. **WP-13 Support Slice v0.1** — acceptance candidate 2026-08-23: common
    ...
    canonical PostgreSQL 18 CI remains required before acceptance.
...
G‑07B и production policy instances остаются `BLOCKED`. WP-11 и WP-12 приняты;
WP-13 является acceptance candidate до canonical CI и не начинает WP-14.
