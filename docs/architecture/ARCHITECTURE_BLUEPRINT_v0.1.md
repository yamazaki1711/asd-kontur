...
15. **G-06 Workspace Lifecycle Foundation v0.1** — candidate baseline
    ...
    DestructionAttestation прошли local PostgreSQL 17.10; canonical PostgreSQL
    18 CI является последним условием `PASS`.
...
локальному и canonical CI evidence. G‑06 имеет local candidate evidence;
G‑07 не начинается автоматически и production policy instances остаются
`BLOCKED`.
