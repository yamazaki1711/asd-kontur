...
class PostgresWorkspaceStorageAdapter:
    ...
    TABLES = (
        ...
        "workspace.assistant_conversations",
        "workspace.pilot_export_versions",
        "workspace.pilot_result_item_decisions",
        ...
        "workspace.material_candidates",
        "workspace.quantity_candidates",
        "workspace.work_type_candidates",
        "workspace.project_structure_node_versions",
        "workspace.project_field_decisions",
        "workspace.project_field_candidates",
        "workspace.document_role_decisions",
        "workspace.document_page_role_candidates",
        "workspace.ocr_extraction_versions",
        "workspace.native_layout_element_versions",
        "workspace.document_page_health_versions",
        "workspace.document_format_inventories",
        ...
        "workspace.applicable_pd_rd_normative_profiles",
        ...
        "workspace.audit_processes",
        "workspace.corpus_unresolved_items",
        "workspace.corpus_snapshot_occurrence_memberships",
        "workspace.corpus_snapshot_conflict_memberships",
        "workspace.corpus_snapshot_duplicate_memberships",
        "workspace.corpus_snapshot_page_memberships",
        "workspace.corpus_snapshot_object_memberships",
        "workspace.corpus_snapshot_reconciliations",
        "workspace.corpus_snapshot_versions",
        "workspace.corpus_reconciliations",
        "workspace.logical_document_occurrences",
        "workspace.corpus_boundary_validations",
        "workspace.corpus_boundary_evidence_receipts",
        "workspace.corpus_boundary_candidate_versions",
        "workspace.corpus_processing_receipts",
        "workspace.corpus_processing_shards",
        "workspace.corpus_processing_plan_versions",
        "workspace.corpus_page_manifests",
        "workspace.physical_object_inspections",
        "workspace.corpus_custody_receipts",
        "workspace.corpus_collected_items",
        "workspace.corpus_acquisition_batches",
        "workspace.collection_sources",
        "workspace.collection_scope_versions",
        "workspace.collection_missions",
        "workspace.support_package_backup_manifests",
        ...
        "workspace.support_terminal_outcomes",
        "workspace.support_deliverable_versions",
        "workspace.support_payment_readiness",
        "workspace.support_presented_volume_readiness",
        "workspace.support_executive_scheme_versions",
        "workspace.support_geometry_input_versions",
        "workspace.support_finalized_document_versions",
        "workspace.support_document_review_decisions",
        "workspace.support_print_validation_results",
        "workspace.support_render_artifacts",
        "workspace.support_generated_document_candidates",
        "workspace.support_generation_evidence_bindings",
        "workspace.support_generation_field_resolutions",
        "workspace.support_generation_runs",
        "workspace.support_binding_plan_versions",
        "workspace.support_generation_requests",
        "workspace.support_id_completeness_evaluations",
