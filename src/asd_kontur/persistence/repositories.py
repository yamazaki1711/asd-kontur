...
class WorkspaceRepository:
    ...
    def create_mode_execution(
        ...
        *,
        ...
        process_definition_key: str = "process.synthetic",
        process_definition_version: str = "0.1.0",
        authority_profile_key: str = "authority.synthetic",
        authority_profile_version: str = "0.1.0",
        output_contract_key: str = "mode.terminal-result",
        output_contract_version: str = "0.1.0",
    ) -> None:
        self._session.execute(
            mode_executions.insert().values(
                ...
                authority_profile_key=authority_profile_key,
